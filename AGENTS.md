...
- Permanent SQL migrations are embedded, semantically ordered `vMAJOR.MINOR.PATCH.sql` files. Current history is `v4.0.0` through `v4.0.10`, eleven ledger rows. Sequence numbers are application order, not release versions; SHA-256 protects release name plus SQL.
